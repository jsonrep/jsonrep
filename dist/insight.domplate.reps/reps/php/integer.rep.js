...
function css() {
  return atob("CltfX2RiaWQ9IjY5NDNjN2Y0ZjI1OWY2MmIwZGVkYzYxYWYzYzg4ZTk4MmI4NDM0M2QiXSBTUEFOLmludGVnZXIgewogICAgY29sb3I6IGdyZWVuOwp9Cg==");
}
...
return (function (__code__, __context__, __in__, __out__) {  DomplateDebug.startGroup([' .. Run Markup .. ','span'],arguments);  DomplateDebug.logJs('js','(function (__code__, __context__, __in__, __out__) {  DomplateDebug.startGroup([\' .. Run Markup .. \',\'span\'],arguments);  DomplateDebug.logJs(\'js\',\'__SELF__JS__\');  with (this) {  with (__in__) {    __code__.push("","<span", " class=\"","integer", " ", "\"",">",__escape__(getValue(node)),"</span>");  }DomplateDebug.endGroup();}})');  with (this) {  with (__in__) {    __code__.push("","<span", " class=\"","integer", " ", "\"",">",__escape__(getValue(node)),"</span>");  }DomplateDebug.endGroup();}})
  ...
  rep.__dbid = "6943c7f4f259f62b0dedc61af3c88e982b84343d";
