...
function css() {
  return atob("CltfX2RiaWQ9ImRhZTVmZjQ1YmI3MjJmNjZkNThmMjU0OTRlNzY4ODM4YmQxNmU5ZDgiXSBTUEFOLmNvbnN0YW50IHsKICAgIGNvbG9yOiAjMDAwMEZGOwp9Cg==");
}
...
return (function (__code__, __context__, __in__, __out__) {  DomplateDebug.startGroup([' .. Run Markup .. ','span'],arguments);  DomplateDebug.logJs('js','(function (__code__, __context__, __in__, __out__) {  DomplateDebug.startGroup([\' .. Run Markup .. \',\'span\'],arguments);  DomplateDebug.logJs(\'js\',\'__SELF__JS__\');  with (this) {  with (__in__) {    __code__.push("","<span", " class=\"","constant", " ", "\"",">",__escape__(node.value),"</span>");  }DomplateDebug.endGroup();}})');  with (this) {  with (__in__) {    __code__.push("","<span", " class=\"","constant", " ", "\"",">",__escape__(node.value),"</span>");  }DomplateDebug.endGroup();}})
  ...
  rep.__dbid = "dae5ff45bb722f66d58f25494e768838bd16e9d8";
